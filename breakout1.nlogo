...
to change-color
  ...
  let max-neighbor-gain max get-all-keys [best-gain-color] of link-neighbors ;;;gains of all neighbors
  ;;; Only change color when the gain is >= the best from neighbors.
...
to-report best-gain-color
  let color-costs map [(list ? cost-of-color ?)] colors
